...
int startGame()
{
    ...
    Texture Background;
    if ( !Background.loadFromFile("cars/Menu.jpg") )
        return EXIT_FAILURE;
    ...
    //Text for Menu
    string Newgame, Highscore, Credits, Exit, Game;
    Game = "Traffic Rush";
    Newgame = "Play";
    Highscore = "High Score";
    Credits = "Credits";
    Exit = " Exit";
    Text name ( Game, myfont, 30 ), game ( Newgame, myfont, 15 ) , high ( Highscore, myfont, 15 ) , cre ( Credits, myfont, 15 ) , exit ( Exit, myfont, 15 ) ;
